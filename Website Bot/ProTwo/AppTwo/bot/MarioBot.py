    ...
    if input_type == "LANG":
        ...
        for i in list(dict.keys()):
            ...
            if (i in message_str) or (message_str in i):
                if (i == "INEEDBLOOD") or (i == "IWANTBLOOD") or (i == "DONOR") or (i == "எனக்குரத்தம்தேவை") or (i == "எனக்குரத்தம்வேண்டும்") or (i == "எனக்குஇரத்தம்தேவை") or (i == "எனக்குஇரத்தம்வேண்டும்") or (i == "இரத்த") or (i == "ரத்த") or (i == "தானம்"):
                    input_type = "BLOOD"

                elif (i == "REGISTER") or (i == "BECOMEADONOR") or (i == "BECOMEABLOODDONOR") or (i == "DONATE") or (i == "DONATEBLOOD") or (i == "பதிவு") or (i == "இரத்ததானம்செய்ய") or (i == "ரத்ததானம்செய்ய") or (i == "தானம்செய்ய"):
                    input_type = "RNAME"
